...
@Service
@Scope("prototype")
public class ShopOverAllRatingAddOneHandler extends AbstractKafkaConsumer {
    @Autowired
    private IShopOverAllRatingService shopOverAllRatingService;
    private Logger logger = LoggerFactory.getLogger(BrandAddOneHandler.class);
    ...
    private void process(ShopOverAllRatingEntity shopOverAllRatingEntity) throws Exception {
        ...
        shopOverAllRatingService.addOne(shopOverAllRatingEntity);
    }
}
