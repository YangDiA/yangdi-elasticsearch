...
@Service
@Scope("prototype")
public class ShopOverAllRatingUpdateOneHandler extends AbstractKafkaConsumer {
    @Autowired
    private IShopOverAllRatingService shopOverAllRatingService;
    private Logger logger = LoggerFactory.getLogger(ShopOverAllRatingUpdateOneHandler.class);
    ...
    private void process(ShopOverAllRatingEntity shopOverAllRatingEntity) throws Exception {
        ...
        shopOverAllRatingService.updateOne(shopOverAllRatingEntity);
    }
}